...
public class FavoriteTwitterSearches extends Activity 
{
   ...
   private void makeTagGUI(String tag, int index)
   {
      ...
      // get newEditButton and register its listener
       ...
       Button newDeleteButton =
               (Button) newTagView.findViewById(R.id.newDeleteButton);
       newDeleteButton.setOnClickListener(editButtonListener);
   ...
   public OnClickListener deleteButtonListener = new OnClickListener()
   {
       ...
       public void onClick(View v)
       {
           ...
           SharedPreferences.Editor preferencesEditor2 = savedSearches.edit();
           preferencesEditor2.remove(tag);
           preferencesEditor2.remove(query);
